    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ url('pacientes/'.$data->id) }}" method="post" onsubmit="return validate_delete()">
                    <div class="card-body">
                        @method('DELETE')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="form-control-static">{{ $data->altura }}</p>
                                </div>
                                <div class="form-group">
                                    <label for="peso">Peso</label>
                                    <p class="form-control-static">{{ $data->peso }}</p>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="card-footer text-right">
                        ...
                        <a href="{{ url('pacientes/edit/'.$data->id) }}" class="btn btn-primary">Editar</a>
                    </div>
                </form>
            </div>
        </div>
