                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                id="data_nascimento" value="{{ old('data_nascimento') }}" name="data_nascimento"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01"
                                ...
                                value="{{ old('altura') }}" name="altura" placeholder="0.00">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01"
                                ...
                                value="{{ old('peso') }}" name="peso" placeholder="0.00">
